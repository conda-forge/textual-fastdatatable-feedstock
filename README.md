About textual-fastdatatable-feedstock
=====================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/textual-fastdatatable-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/textual-fastdatatable-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add textual-fastdatatable
# for installing globally
pixi global install textual-fastdatatable
```
...
It is possible to list all of the versions of `textual-fastdatatable` available on your platform:
...
```
pixi search textual-fastdatatable --channel conda-forge
```
